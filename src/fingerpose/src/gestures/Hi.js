...
hiDescription.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 0.75);
...
hiDescription.addDirection(Finger.Index, FingerDirection.DiagonalUpRight, 0.75);
...
hiDescription.addDirection(Finger.Ring, FingerDirection.DiagonalUpLeft, 0.75);
...
hiDescription.addDirection(Finger.Pinky, FingerDirection.DiagonalUpLeft, 1);
